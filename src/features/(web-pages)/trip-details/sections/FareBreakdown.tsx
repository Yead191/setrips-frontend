      ...
      <div className="pt-2 border-t border-gray-100 flex flex-col items-end gap-1">
        ...
        <div className="flex justify-between w-full items-end pt-2">
          <div className="space-y-0.5">
            <p className="text-[10px] md:text-[12px] font-bold text-gray-400">Total Payable</p>
            <p className="text-[11px] md:text-sm text-gray-500 font-medium">Original price <span className="line-through text-gray-500">$1200.00</span></p>
          </div>
          <p className="text-xl md:text-2xl font-semibold text-[#111827] leading-none">$1080.00</p>
        </div>
      </div>
    </div>
