    ...
    <section className="py-10 md:py-20 bg-white">
      <div className="container mx-auto px-4 md:px-0">
        <div className="text-center mb-10 md:mb-16 space-y-2">
          <p className="text-primary font-bold tracking-[0.2em] uppercase text-xs md:text-sm">
            ADVANTAGES
          </p>
          <SectionTitle title={title || "Our Services"} align={align || "center"} className="" />
          <p className="text-gray-500 text-[13px] md:text-[15px] max-w-xs sm:max-w-md md:max-w-2xl text-center mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 md:gap-x-12 gap-y-10 md:gap-y-16">
          {ADVANTAGES_DATA.map((advantage) => {
            ...
            return (
              <div key={advantage.id} className="flex items-start gap-4 md:gap-6 group">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl md:text-2xl font-semibold text-[#3B3B3B] tracking-tight">
                    {advantage.title}
                  </h3>
                  <p className="text-[#505050] text-[13px] md:text-[15px] leading-relaxed font-normal">
