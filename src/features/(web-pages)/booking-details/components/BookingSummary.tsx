...
import { MapPin, Calendar, Users, ShieldCheck, Lock, CreditCard } from "lucide-react";
...
export const BookingSummary = () => {
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-4 relative">
          ...
          <div className="flex gap-4 relative">
             ...
             <div>
                ...
                <p className="text-sm font-bold text-gray-900">Downtown Hotel</p>
          ...
          <div className="flex gap-4 relative">
             ...
             <div>
                ...
                <p className="text-sm font-bold text-gray-900">International Airport</p>
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray-900">March 15, 2024 • 9:00 AM</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray-900">2 Passengers</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Fare Breakdown Card */}
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-6">
        <h2 className="text-xl font-bold text-gray-900">Fare Breakdown</h2>
        ...
        <div className="space-y-3">
          ...
          <FareItem label="First ride discount" value="-$10.00" isDiscount />
        </div>
        ...
        <div className="pt-4 border-t border-gray-50">
          <div className="flex justify-between items-end">
            ...
            <p className="text-2xl font-black text-gray-900 tracking-tight">$1080.95</p>
          </div>
        </div>
...
const FareItem = ({ label, value, isDiscount = false }: { label: string; value: string; isDiscount?: boolean }) => (
  <div className="flex justify-between items-center">
    <span className={`text-sm ${isDiscount ? "text-emerald-600 font-bold" : "text-gray-500 font-medium"}`}>{label}</span>
    <span className={`text-sm font-bold ${isDiscount ? "text-emerald-600" : "text-gray-900"}`}>{value}</span>
  </div>
);
