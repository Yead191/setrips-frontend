  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-4">
        <h2 className="text-lg md:text-xl font-semibold text-gray-900">Trip Summary</h2>

        {/* Map Thumbnail */}
        <div className="relative w-full h-[160px] md:h-[180px] rounded-2xl overflow-hidden border border-gray-100 group cursor-pointer">
          <iframe
            width="100%"
            height="100%"
            frameBorder="0"
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <button className="bg-white/95 backdrop-blur-sm text-gray-900 px-4 py-2 rounded-full text-[10px] md:text-xs font-bold shadow-xl border border-white hover:bg-blue-600 hover:text-white transition-all whitespace-nowrap">
        ...
        <div className="space-y-4 relative">
          ...
          <div className="flex gap-4 relative">
            ...
            <div>
              <p className="text-[10px] text-[#171717] font-medium uppercase tracking-wider">Pickup</p>
              <p className="text-sm font-medium text-[#4B5563] ">Downtown Hotel</p>
              <p className="text-[11px] md:text-xs text-gray-500">123 Main Street, City Center</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 relative">
            ...
            <div>
              <p className="text-[10px] text-[#171717] font-medium uppercase tracking-wider">Drop-off</p>
              <p className="text-sm  text-[#4B5563] font-medium">International Airport</p>
              <p className="text-[11px] md:text-xs text-gray-500">Terminal 1, Departure Hall</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] md:text-xs font-medium text-[#4B5563]">Mar 15 • 9:00 AM</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] md:text-xs font-medium text-[#4B5563]">2 Pax</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Fare Breakdown Card */}
      <div className="bg-white rounded-3xl p-4 md:p-5 shadow-sm border border-gray-100 space-y-3">
        <h2 className="text-lg md:text-xl font-medium text-gray-900">Fare Breakdown</h2>
        ...
        <div className="pt-4 border-t border-[#E5E7EB] space-y-2">
          <div className="flex justify-between items-center">
            <p className="text-xs md:text-sm text-emerald-600">First ride discount</p>
            <p className="text-xs md:text-sm font-medium text-emerald-600 tracking-tight">-$10.00</p>
          </div>
          <div className="flex justify-between items-end">
            <div>
              <p className="text-base md:text-lg font-bold text-gray-900">Total Payable</p>
              <p className="text-[10px] md:text-xs text-gray-400">Original price <span className="line-through">$1089.00</span></p>
            </div>
            <p className="text-xl md:text-2xl font-semibold text-gray-900 tracking-tight">$1080.95</p>
          </div>
        </div>
        ...
        <div className="space-y-4 pt-2">
          ...
          <Button className="w-full h-12 md:h-14 rounded-2xl bg-blue-700 hover:bg-blue-800 text-sm md:text-base font-bold transition-all shadow-lg shadow-blue-100">
            Continue to Payment
          </Button>
